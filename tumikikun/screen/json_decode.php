...
//ファイルの有無処理
$process_file = './stage_sougen/StreamingAssets/' . $cookie_id . '.json';
...
//ファイルの有無処理
$number_file = './stage_sougen/StreamingAssets/' . $cookie_id . 'ohs.json';
...
header("Location: https://halproducts.main.jp/testUpdate/screen/stage_sougen/index.html");
exit;
