...
//ファイルの有無処理
$process_file = './stage_castle/StreamingAssets/'.$cookie_id.'.json';
...
//ファイルの有無処理
$number_file = './stage_castle/StreamingAssets/'.$cookie_id.'ohs.json';
...
header("Location: https://halproducts.main.jp/screen/stage_castle/index.html");
exit;
